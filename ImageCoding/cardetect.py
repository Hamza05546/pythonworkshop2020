...
video = cv2.VideoCapture(r"/home/aiktc/Desktop/hamza/imagecoding/car.mp4")
#print(type(video))
#print(type(check))
check=True
while check:
    ...
    faces = face_cascade.detectMultiScale(gray_img,scaleFactor=1.04,minNeighbors=5)  #scale should be btwn 

    for x,y,w,h in faces:
        img = cv2.rectangle(img,(x,y),(x+w,y+h),(0,555,555),3)
